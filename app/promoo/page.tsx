...
export default function Promo1001Bites() {
  ...
  const BackgroundWrapper = ({ children }: { children: React.ReactNode }) => (
    <div className="relative min-h-[100dvh] w-full flex items-center justify-center p-2 font-sans text-[#1a1a1a] overflow-hidden">
      ...
      <div className="relative z-10 w-full flex justify-center scale-[0.9] sm:scale-100 transition-transform">
        {children}
      </div>
    </div>
  );

  if (status === 'loading') return <div className="min-h-screen bg-white flex items-center justify-center text-gray-400 font-bold text-sm">Memuat...</div>;
      ...
      <BackgroundWrapper>
        <div className="w-full max-w-[310px] bg-[#FDF9F3] rounded-[2.5rem] shadow-2xl text-center p-6 border border-white/50 animate-in fade-in zoom-in duration-500">
          ...
          <div className="space-y-0.5">
            <h2 className="text-[11px] font-black text-gray-900 tracking-tighter uppercase leading-none">SELAMAT!</h2>
            <h2 className="text-[11px] font-black text-gray-900 tracking-tighter uppercase">KAMU MENDAPATKAN</h2>
          </div>
          ...
          <div className="bg-[#FEF2E4] rounded-[1.5rem] py-3 mb-4 border border-orange-100 shadow-inner">
            ...
            <p className="text-[8px] font-bold text-orange-800/60 uppercase tracking-[0.1em] mt-0.5">Sisa Promo</p>
          </div>
          ...
          <p className="mt-4 text-[8px] text-gray-400 font-medium">*Hanya untuk 20 orang pertama</p>
  ...
  return (
    <BackgroundWrapper>
      <div className="bg-white p-8 rounded-[2rem] shadow-xl max-w-[280px] w-full text-center border border-gray-100 animate-in fade-in">
